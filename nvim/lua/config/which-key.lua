	...
	local keymap = {
		...
		w = {
			...
			g = {
				...
				r = { "<Plug>(wiki-graph-related)", "Related" },
				c = { "<Plug>(wiki-graph-check-links)", "Check Links" },
				C = { "<Plug>(wiki-graph-check-links-g)", "Check Links Global" },
				i = { "<Plug>(wiki-graph-in)", "In" },
				o = { "<Plug>(wiki-graph-out)", "Out" },
			},
			f = { "<Plug>(wiki-link-transform)", "Link Transform" },
			...
			p = { "<Plug>(wiki-export)", "Export" },
			l = {
				name = "Link",
				l = { "<Plug>(wiki-link-show)", "Show" },
				h = { "<Plug>(wiki-link-extract-header)", "Extract Header" },
			},
			s = {
				name = "Tag",
				l = { "<Plug>(wiki-tag-list)", "List" },
				r = { "<Plug>(wiki-tag-reload)", "Reload" },
				n = { "<Plug>(wiki-tag-rename)", "Rename" },
		...
		g = {
			...
			o = {
				...
				i = {
					...
					a = { "<cmd>Octo issue create<cr>", "Creates a new issue in the current or specified repo" },
					e = { "<cmd>Octo issue edit ", "Edit issue <number> in current or specified repo" },
					l = { "<cmd>Octo issue list<cr>", "List all issues satisfying given filter" },
					s = { "<cmd>Octo issue search<cr>", "Live issue search" },
					i = { "<cmd>Octo issue reload<cr>", "Reload issue. Same as doing e!" },
				...
				p = {
					name = "+PR",
					l = { "<cmd>Octo pr list<cr>", "List all PRs satisfying given filter" },
					s = { "<cmd>Octo pr search<cr>", "Live issue search" },
					e = { "<cmd>Octo pr edit ", "Edit PR <number> in current or specified repo" },
					...
					g = { "<cmd>Octo pr merge ", "Merge current PR using the specified method" },
					y = { "<cmd>Octo pr ready<cr>", "Mark a draft PR as ready for review" },
					k = { "<cmd>Octo pr checks<cr>", "Show the status of all checks run on the PR" },
					p = { "<cmd>Octo pr reload<cr>", "Reload PR. Same as doing e!" },
				...
				g = { "<cmd>Octo gist list<cr>", "List user gists" },
				c = {
					name = "+Comment",
				...
				l = {
					name = "+Label",
					a = { "<cmd>Octo label add ", "Add a label from available label menu" },
					r = { "<cmd>Octo label remove ", "Remove a label" },
					c = { "<cmd>Octo label create ", "Create a new label" },
				},
				a = {
					name = "+Assignee",
					a = { "<cmd>Octo assignee add ", "Assign a user" },
					r = { "<cmd>Octo assignee remove ", "Unassign a user" },
				},
				v = {
					name = "+Review",
					a = { "<cmd>Octo reviewer add ", "Assign a PR reviewer" },
					...
					m = { "<cmd>Octo review commit<cr>", "Pick a specific commit to review" },
					x = { "<cmd>Octo review close<cr>", "Close the review window and return to the PR" },
				},
				e = {
					name = "+Reaction",
					u = { "<cmd>Octo reaction +1<cr>", "Add 👍 reaction" },
					d = { "<cmd>Octo reaction -1<cr>", "Add 👎 reaction" },
					...
					y = { "<cmd>Octo reaction hooray<cr>", "Add 🎉 reaction" },
				},
				d = {
					name = "+Card",
				...
				x = { "<cmd>Octo actions<cr>", "Lists all available Octo actions" },
